...
-1 "Creating local partitioned database in ./db for use within the current section.";
...
bgn:2020.01.01      / begin, end
end:2020.01.31      / (only mon-fri used)

/ approximate values:
nt:10000             / trades per stock per day
